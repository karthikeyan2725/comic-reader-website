...
function HomePage(){
    ...
    function setHotPanel(num){
        document.getElementById("item-" + num).scrollIntoView({behavior:"smooth", block: 'nearest', inline: 'nearest'})
    }

    useEffect(()=>{
        setHotPanel(panelNum)
    }, [panelNum])

    return <div className="home-page">
                <div className="hot-panel">
                    <div  className="hot-panel-items">
                        <div id="item-0" className="hot-panel-item">
                        ...
                        <div id = "item-1" className="hot-panel-item">
                            <h1 className="comic-name">{"Kaiju No 8"}</h1>
                            <div className="info">
                                <img className="cover-art" src={devCoverUrl}></img>
                                <div className="cover-art-spacer"></div>
                        ...
                        <div id="item-2" className="hot-panel-item">
                            <h1 className="comic-name">{"Kaiju No 8"}</h1>
                            <div className="info">
                                <img className="cover-art" src={devCoverUrl}></img>
                                <div className="cover-art-spacer"></div>
                        ...
                        <div id="item-3" className="hot-panel-item">
                            <h1 className="comic-name">{"Kaiju No 8"}</h1>
                            <div className="info">
                                <img className="cover-art" src={devCoverUrl}></img>
                                <div className="cover-art-spacer"></div>
                        ...
                        <div id="item-4" className="hot-panel-item">
                            <h1 className="comic-name">{"Kaiju No 8"}</h1>
                            <div className="info">
                                <img className="cover-art" src={devCoverUrl}></img>
                                <div className="cover-art-spacer"></div>
                    ...
                    <div className="panel-selector">
                        {[0,1,2,3,4].map((n, i)=>
                            <div id={"hot-"+n}className="hot-radio"> {/* Unique Key problem*/}
